...
export class News extends Component {
    ...
    async componentDidMount() {
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=e0b6e5ecdcff447aa3af7d9f2d83fbb7&page=1&pagesize=${this.props.pagesize}`
        ...
        return (
            <div>
                <div className="container my-3">
                    <h2 className='text-center my-4'>News Feed-{this.props.category}</h2>
                    {this.state.loading &&<Loading/>}
                    <div className="row" >
                        {!this.state.loading && this.state.articles.map((element) => {
                            return <div className="col-md-4 my-2" key={element.url} >
                            <Newscomponent title={!element.slice?element.title.slice(0,45):""} 
